...
Ported verbatim from Bitcoin Core v0.21.2 (commit 831599913d) except for the
TMPDIR_PREFIX (must match test_framework.test_framework) and daemon wording; the
log-merge logic is chain-agnostic and works for regtest/testnet alike."""
