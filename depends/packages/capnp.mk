package=capnp
# Reuse the download/version/hash from native_capnp so the cross-compiled runtime
# and the native code generator always come from the same Cap'n Proto release.
