...
bool StakeAcidTest(std::string grc_address, double por_diff, std::string last_block_hash, int height, unsigned int nonce)
{
	...
	uint256 diff1 = uint256("0x00006fffffffffffffffffffffffffff");
	uint256 diff2 = uint256("0x00004fffffffffffffffffffffffffff");
	uint256 diff3 = uint256("0x00003fffffffffffffffffffffffffff");
	uint256 diff4 = uint256("0x00002fffffffffffffffffffffffffff");
	uint256 diff5 = uint256("0x00001fffffffffffffffffffffffffff");
	uint256 diff6 = uint256("0x00000fffffffffffffffffffffffffff");
	uint256 diff7 = uint256("0x000006ffffffffffffffffffffffffff");
