...
{ //  name                      function                 category
  ...
  // Wallet commands
    ...
    { "getaddressesbylabel",     &getaddressesbylabel,     cat_wallet, &getaddressesbylabel_helpman        },
    ...
    { "listlabels",              &listlabels,              cat_wallet, &listlabels_helpman        },
    ...
    { "migratelabels",           &migratelabels,           cat_wallet, &migratelabels_helpman        },
    ...
    { "setlabel",                &setlabel,                cat_wallet, &setlabel_helpman        },
  ...
  // Developer commands
    ...
    { "withdrawpool",            &withdrawpool,            cat_staking, &withdrawpool_helpman     },
  ...
  // Network commands
    ...
    { "testmempoolaccept",       &testmempoolaccept,       cat_network, &testmempoolaccept_helpman       },
