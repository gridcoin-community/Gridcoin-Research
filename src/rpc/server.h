...
extern UniValue savemempool(const UniValue& params);
extern UniValue importmempool(const UniValue& params);
...
extern const RPCHelpMan& savemempool_helpman();
extern const RPCHelpMan& importmempool_helpman();
