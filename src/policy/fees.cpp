...
CAmount GetBaseFee(const CTransaction& tx, enum GetMinFee_mode mode)
{
...
CAmount GetMinFee(const CTransaction& tx, unsigned int nBlockSize, enum GetMinFee_mode mode, unsigned int nBytes)
{
