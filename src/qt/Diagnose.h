...
class Diagnose{
	...
	public:
		...
		enum diagnoseResults {PASS,WARNING,FAIL,NONE};
		enum TestNames {
 ...
 */
class VerifyClock: public CheckConnectionCount, public QObject{
	Q_OBJECT
	private slots:
    		void clkFinished();
	...
	private: 
		...
		/*bool m_hasQAppstartedBefore = false;
	...
	public:
		VerifyClock(){
			/*if (QCoreApplication::instance() == NULL){
       				...
       				app->exec();
				m_hasQAppstartedBefore = false;
   			}else{
				m_hasQAppstartedBefore = true;
			}*/
	...
	public:
		...
		void runCheck(){
			auto CheckConnectionCount_Test = getTest(Diagnose::CheckConnectionCount);
    			if (CheckConnectionCount_Test 
			   &&  CheckConnectionCount_Test->getResults() != Diagnose::NONE 
