...
<context>
    ...
    <message>
        ...
        <translation type="vanished">???????? ??? ??? ?????? ????????? ???? ????????? &lt;br/&gt; ???????? ??????????????? ??? ?????? ?? &lt;b&gt; 10 ? ????????????? ???????? ??????????&lt;/b&gt; ? &lt;b&gt; ???? ? ???????? ??????&lt;/b&gt;.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>SOCKS ?????? ??? ????????????? (e.g. 5)</translation>
    </message>
    <message>
        <location line="+36"/>
...
<context>
    ...
    <message>
        ...
        <translation>?????????????? ??? ???????? ??????????, ?????? (??????????? ??? ????? ?????????? ??? ??????? ???????, ????, tabs, ?.??. ???????) ??? ??? ???????? ????????, ??? ?? ??????? ?? ??????. ?? ????? ??????????? ??? ?? ??? ????????? ??????????? ???? ???????? ?, ?? ????? ???? ???????? ???? ?? ?????? , ??? ?? ??? ??????????? ??? ???? ??????? -in - the-middle ???????.</translation>
    </message>
    <message>
        <location line="+21"/>
...
<context>
    ...
    <message>
        ...
        <translation>????? ?? ??????? ??? ????? ?????????? ??????????? ?? megabytes(??????????:25)</translation>
    </message>
    <message>
        <location line="+1"/>
    ...
    <message>
        ...
        <translation>???????? ??????? ????????? ?? ???? peers &lt;n&gt; (??????????: 125)</translation>
    </message>
    <message>
        <location line="+3"/>
    ...
    <message>
        ...
        <translation>???? ??????????? ????????????? peers (??????????: 100)</translation>
    </message>
    <message>
        <location line="+1"/>
        <source>Number of seconds to keep misbehaving peers from reconnecting (default: 86400)</source>
        <translation>???????????? ???? ????????? ???? ? ??????? ??? ????????????? peers (??????????: 86400)</translation>
    </message>
    <message>
        <location line="-43"/>
    ...
    <message>
        ...
        <translation>????????????? : ?? ?????? wallet.dat ????? ???????????, ?? ???????? ???????? ! Original wallet.dat ????????????? ?? wallet.{timestamp}.bak ??? %s . ?? ?? ???????? ??? ? ??? ?????????? ???, ????? ????? ?? ?????? ?? ??????????? ??? ??? ????????? ?????????</translation>
    </message>
    <message>
        <location line="-31"/>
    ...
    <message>
        ...
        <translation>???????? buffer ????? ??? ???????, &lt;n&gt;*1000 bytes (??????????: 5000)</translation>
    </message>
    <message>
        <location line="+1"/>
        <source>Maximum per-connection send buffer, &lt;n&gt;*1000 bytes (default: 1000)</source>
        <translation>???????? buffer ????????? ??? ???????, &lt;n&gt;*1000 bytes (??????????: 1000)</translation>
    </message>
    <message>
        <location line="-15"/>
...
for example: alertnotify=echo %%s | mail -s &quot;Gridcoin Alert&quot; admin@foo.com
    ...
    <message>
        ...
        <translation>?????? ?? ??????? ??????? ????? ?? bytes (??????????: 0)</translation>
    </message>
    <message>
        <location line="-29"/>
    ...
    <message>
        ...
        <translation>???????? ??? ?????? ???? ?? ???????? ????? ???????(%s ???? ?????? ?????????????? ??? ?? hash ??? ?????)</translation>
    </message>
    <message>
        <location line="+3"/>
    ...
    <message>
        ...
        <translation>???? ??????? ???????? pool &lt;n&gt; (??????????: 100)</translation>
    </message>
    <message>
        <location line="+1"/>
    ...
    <message>
        ...
        <translation>??????o ?????? ???????? ?? onlynet: &apos;%s&apos;</translation>
    </message>
    <message>
        <location line="-1"/>
