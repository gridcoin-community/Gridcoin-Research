...
?????: %4
    ...
    <message>
        ...
        <translation>?? ??????? ?????????? URI! ??? ????? ???? ??????? ? ???????? ??????? Gridcoin ??? ????????????? ??????????? URI.</translation>
    </message>
    <message>
        <location line="+18"/>
...
<context>
    ...
    <message>
        ...
        <translation>????????? ????? &quot;%1&quot; ?? ???????? ?????????? Gridcoin-???????.</translation>
    </message>
    <message>
        <location line="+10"/>
...
<context>
    ...
    <message>
        ...
        <translation>????????????? ??????? ???? ??? Gridcoin-??????? ?? ???????. ???????? ?????? ???? ??? ?????? ???????????? UPnP, ? ?????? ??????? ????????.</translation>
    </message>
    <message>
        <location line="+3"/>
    ...
    <message>
        ...
        <translation>???????????? ? ???? Gridcoin ????? ?????? SOCKS (????????, ??? ??????????? ????? Tor).</translation>
    </message>
    <message>
        <location line="+3"/>
...
<context>
    ...
    <message>
        ...
        <translation>????? ?????????? ? RPC-??????? Gridcoin.</translation>
    </message>
    <message>
        <location line="+1"/>
...
<context>
    ...
    <message>
        ...
        <translation>??????? Gridcoin-????? (???????? B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)</translation>
    </message>
    <message>
        <location line="+15"/>
        <source>Copy quantity</source>
...
<context>
    ...
    <message>
        ...
        <translation>???????????? ??????????? JSON-RPC ?? &lt;?????&gt; (?? ?????????: 15715 ??? ??? testnet: 25715)</translation>
    </message>
    <message>
        <location line="-11"/>
...
for example: alertnotify=echo %%s | mail -s &quot;Gridcoin Alert&quot; admin@foo.com
    ...
    <message>
        ...
        <translation>?????? ???????? wallet.dat: ???????? ??????? ????? ????? ?????? Gridcoin</translation>
    </message>
    <message>
        <location line="+1"/>
    ...
    <message>
        ...
        <translation>?????????? ??????????? ? %s ?? ???? ??????????.  ????????, Gridcoin ??? ????????.</translation>
    </message>
    <message>
        <location line="-97"/>
