...
Copyright © 2014 The Gridcoin developers</source>
        <translation type="vanished">?????? © 2009-2014 The Bitcoin developers
?????? © 2012-2014 The NovaCoin developers
?????? © 2014 The Gridcoin developers</translation>
    </message>
    <message>
        <location line="+58"/>
        <source>
...
????? OpenSSL Toolkit (http://www.openssl.org/) ??????  Eric Young (eay@cryptsoft.com)  ??????????????? Thomas Bernard ????? UPnP ??????????????</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>???????????????????????sendmoney??????????????????</translation>
    </message>
    <message>
        <location line="+3"/>
    ...
    <message>
        ...
        <translation type="vanished">?????????????????????????&lt;br/&gt;&lt;b&gt;8???????10???????????&lt;/b&gt;?????????</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Qt ????(&amp;Q)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">??????&lt;br&gt;???%1&lt;br&gt;??????????%2&lt;br&gt;????????????%3</translation>
    </message>
    <message>
        <location line="+1116"/>
...
<context>
    ...
    <message>
        ...
        <translation>???????????????????????????1KB????0.01??????</translation>
    </message>
    <message>
        <location line="+15"/>
    ...
    <message>
        ...
        <translation>?????????????????????????????????????????UPnP????????UPnP????????????</translation>
    </message>
    <message>
        <location line="+3"/>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">???????RPC???????????</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">?????????????? (??B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>?????????????????????????????????????wallet.dat??????????????wallet.dat???????????????</translation>
    </message>
    <message>
        <location line="+251"/>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">??????????????????510??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">-server ? Gridcoind?????????</translation>
    </message>
    <message>
        <location line="+2"/>
    ...
    <message>
        ...
        <translation type="vanished">??????????? (?????: Gridcoin.conf)</translation>
    </message>
    <message>
        <source>Specify pid file (default: Gridcoind.pid)</source>
        <translation type="vanished">pid ????????? (?????: Gridcoind.pid)</translation>
    </message>
    <message>
        <location line="+5"/>
    ...
    <message>
        ...
        <translation type="vanished">&lt;port&gt; ? ?????? (?????: 15714?testnet ? 25714)</translation>
    </message>
    <message>
        <location line="+7"/>
    ...
    <message>
        ...
        <translation>????????IPv6????[host]:port ????????????</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>IPv4 ?????? RPC ??? %u ???????????????: %s</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;port&gt; ? JSON-RPC ?????? (?????: 15715?testnet ? 25715)</translation>
    </message>
    <message>
        <location line="-11"/>
...
for example: alertnotify=echo %%s | mail -s &quot;Gridcoin Alert&quot; admin@foo.com
    ...
    <message>
        ...
        <translation type="unfinished">&lt;port&gt; ? ?????? (?????: 15714?testnet ? 25714) {32749 ?} {32748)?}</translation>
    </message>
    <message>
        <location line="+31"/>
    ...
    <message>
        ...
        <translation>SSL ?????: (SSL?????????? Bitcoin Wiki ??????)</translation>
    </message>
    <message>
        <location line="-71"/>
    ...
    <message>
        ...
        <translation>??????TOR????????(TOR Hidden Services)?????(??????-proxy???)</translation>
    </message>
    <message>
        <location line="+39"/>
...
for example: alertnotify=echo %%s | mail -s &quot;Gridcoin Alert&quot; admin@foo.com
        ...
        <translation type="vanished">%s, ???????%s?rpcpassword?????????????????
...
??????????????????????????????????????????
??????????????alertnotify?????????????????
??alertnotify=echo %%s | mail -s &quot;?????????&quot; admin@foo.com
</translation>
    </message>
    <message>
        <location line="-30"/>
        <source>Find peers using internet relay chat (default: 0)</source>
        <translation>??????????????(IRC)????????(?????:1 {0}?)</translation>
    </message>
    <message>
        <location line="+4"/>
        <source>Sync time with other nodes. Disable if time on your system is precise e.g. syncing with NTP (default: 1)</source>
        <translation>?????????????????????????????????????NTP????????(??????1)</translation>
    </message>
    <message>
        <location line="+13"/>
    ...
    <message>
        ...
        <translation>wallet.dat ???????: ????????QT?????????????</translation>
    </message>
    <message>
        <location line="+1"/>
