...
? ?????? OpenSSL ??(http://www.openssl.org) ?? ???? ??? OpenSSL ????? ???? ???, ??? ????? Eric Young(eay@cryptsoft.com)?, UPnP ????? Thomas Bernard? ??????.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">??? ??? ??? ??. 8??? ?? ??? ????? 10 ??? ?? ?? ??? ??? ?????.</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s &quot;Gridcoin Alert&quot; admin@foo.com
    ...
    <message>
        ...
        <translation>????? ??? debug.log ?? ???(???: ??? ??? 1)</translation>
    </message>
    <message>
        <location line="-39"/>
