...
template <> constexpr inline auto QValidatedLineEdit::qt_create_metaobjectdata<qt_meta_tag_ZN18QValidatedLineEditE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QValidatedLineEdit, qt_meta_tag_ZN18QValidatedLineEditE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QValidatedLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18QValidatedLineEditE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18QValidatedLineEditE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18QValidatedLineEditE_t>.metaTypes,
    nullptr
} };
...
void QValidatedLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setValid((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
...
void *QValidatedLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18QValidatedLineEditE_t>.strings))
